        ...
        <div id="sidebar" :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}"
            ...
            <nav class="mt-10">
                <a href="/admin/dashboard"
                    class="block py-2.5 px-4 rounded transition duration-200  text-white hover:bg-purple-500">
                ...
                <a href="/admin/products"
                    class="block py-2.5 px-4 rounded transition duration-200 bg-purple-700 hover:bg-purple-700">
                        ...
                        <table class="w-full table-auto">
                            <thead>
                                <tr class="bg-gray-100">
                                    ...
                                    <th class="px-4 py-2 text-left text-gray-600 text-sm font-medium">Prix (MAD)</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-2 py-2 text-sm">{{ number_format($product->PR_PRIX, 2, ',', ' ') }} MAD</td>
