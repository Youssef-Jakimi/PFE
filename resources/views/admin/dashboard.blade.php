...
<body class="bg-gray-100">
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-100">
        ...
        <div id="sidebar" :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}"
            ...
            <nav class="mt-10">
                <a href="/admin/dashboard"
                    class="block py-2.5 px-4 rounded transition duration-200 bg-purple-700 text-white hover:bg-purple-500">
                    <i class="fas fa-home mr-2"></i>Dashboard
                </a>
                <a href="/admin/reservations"
                    class="block py-2.5 px-4 rounded transition duration-200 hover:bg-purple-700">
        ...
        <button id="sidebarToggle" @click="sidebarOpen = !sidebarOpen" class="sidebar-toggle md:hidden fixed top-5 left-5 bg-purple-600 text-white p-3 rounded-md shadow-lg">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-md flex justify-between items-center py-4 px-6">
                <div class="flex items-center">
                    <button id="sidebarToggleMobile" @click="sidebarOpen = !sidebarOpen" class="text-gray-500 focus:outline-none md:hidden">
                        <i class="fas fa-bars"></i>
                    </button>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <div class="text-2xl font-bold">{{ number_format($factures, 2, ',', ' ') }} MAD</div>
                        </div>
                    </div>
                </div>
